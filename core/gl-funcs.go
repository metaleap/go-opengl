...
// /* a quick-and-dirty way to determine if (at least) 3.2 core profile (or higher) is provided: */
// 	return ((ptrglFramebufferTexture == NULL) ? 0 : 1);
// }
import "C"
import "fmt"
import "unsafe"
...
//	If Support.MultiTexCoordP4uiv() is true, calls MultiTexCoordP4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsProgram() is true, calls IsProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElementsInstancedBaseVertexBaseInstance() is true, calls DrawElementsInstancedBaseVertexBaseInstance() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP4ui() is true, calls MultiTexCoordP4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawArraysInstancedBaseInstance() is true, calls DrawArraysInstancedBaseInstance() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2uiv() is true, calls ProgramUniform2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsVertexArray() is true, calls IsVertexArray() and yields the err returned by Util.Error(), if any.
...
//	If Support.ShaderStorageBlockBinding() is true, calls ShaderStorageBlockBinding() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSamplerParameteriv() is true, calls GetSamplerParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexP2ui() is true, calls VertexP2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4dv() is true, calls Uniform4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP3ui() is true, calls TexCoordP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.Disablei() is true, calls Disablei() and yields the err returned by Util.Error(), if any.
...
//	If Support.UnmapBuffer() is true, calls UnmapBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1fv() is true, calls Uniform1fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.EnableVertexAttribArray() is true, calls EnableVertexAttribArray() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElementsInstancedBaseInstance() is true, calls DrawElementsInstancedBaseInstance() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformIndices() is true, calls GetUniformIndices() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteSamplers() is true, calls DeleteSamplers() and yields the err returned by Util.Error(), if any.
...
//	If Support.RenderbufferStorageMultisample() is true, calls RenderbufferStorageMultisample() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2i() is true, calls Uniform2i() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexP2uiv() is true, calls VertexP2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DepthRangeIndexed() is true, calls DepthRangeIndexed() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI3ui() is true, calls VertexAttribI3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribLPointer() is true, calls VertexAttribLPointer() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3ui() is true, calls Uniform3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenBuffers() is true, calls GenBuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.DispatchComputeIndirect() is true, calls DispatchComputeIndirect() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetPointerv() is true, calls GetPointerv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribBinding() is true, calls VertexAttribBinding() and yields the err returned by Util.Error(), if any.
...
//	If Support.QueryCounter() is true, calls QueryCounter() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiDrawArrays() is true, calls MultiDrawArrays() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP2ui() is true, calls MultiTexCoordP2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetFloatv() is true, calls GetFloatv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramPipelineInfoLog() is true, calls GetProgramPipelineInfoLog() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2dv() is true, calls ProgramUniform2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendEquationSeparate() is true, calls BlendEquationSeparate() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexStorage1D() is true, calls TexStorage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiDrawArraysIndirect() is true, calls MultiDrawArraysIndirect() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3fv() is true, calls ProgramUniform3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetObjectPtrLabel() is true, calls GetObjectPtrLabel() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferTexture2D() is true, calls FramebufferTexture2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClampColor() is true, calls ClampColor() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL2dv() is true, calls VertexAttribL2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveAtomicCounterBufferiv() is true, calls GetActiveAtomicCounterBufferiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Finish() is true, calls Finish() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4ui() is true, calls VertexAttribI4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.InvalidateBufferSubData() is true, calls InvalidateBufferSubData() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2ui() is true, calls Uniform2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.ObjectLabel() is true, calls ObjectLabel() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetQueryObjectiv() is true, calls GetQueryObjectiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearBufferuiv() is true, calls ClearBufferuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetInternalformativ() is true, calls GetInternalformativ() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteFramebuffers() is true, calls DeleteFramebuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetStringi() is true, calls GetStringi() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexParameterfv() is true, calls GetTexParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramResourceIndex() is true, calls GetProgramResourceIndex() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsQuery() is true, calls IsQuery() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1i() is true, calls Uniform1i() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramInterfaceiv() is true, calls GetProgramInterfaceiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI2ui() is true, calls VertexAttribI2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexParameterf() is true, calls TexParameterf() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL3dv() is true, calls VertexAttribL3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenTransformFeedbacks() is true, calls GenTransformFeedbacks() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2ui() is true, calls ProgramUniform2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetFragDataIndex() is true, calls GetFragDataIndex() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribIFormat() is true, calls VertexAttribIFormat() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetShaderSource() is true, calls GetShaderSource() and yields the err returned by Util.Error(), if any.
...
//	If Support.ColorMask() is true, calls ColorMask() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3f() is true, calls ProgramUniform3f() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompressedTexSubImage3D() is true, calls CompressedTexSubImage3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.BeginQuery() is true, calls BeginQuery() and yields the err returned by Util.Error(), if any.
...
//	If Support.SamplerParameterIuiv() is true, calls SamplerParameterIuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix2dv() is true, calls ProgramUniformMatrix2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindVertexArray() is true, calls BindVertexArray() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformfv() is true, calls GetUniformfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.NormalP3ui() is true, calls NormalP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteVertexArrays() is true, calls DeleteVertexArrays() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindFragDataLocation() is true, calls BindFragDataLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.InvalidateFramebuffer() is true, calls InvalidateFramebuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI1i() is true, calls VertexAttribI1i() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsBuffer() is true, calls IsBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix3dv() is true, calls ProgramUniformMatrix3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearBufferData() is true, calls ClearBufferData() and yields the err returned by Util.Error(), if any.
...
//	If Support.BufferSubData() is true, calls BufferSubData() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL4dv() is true, calls VertexAttribL4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElements() is true, calls DrawElements() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexStorage2D() is true, calls TexStorage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProvokingVertex() is true, calls ProvokingVertex() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenRenderbuffers() is true, calls GenRenderbuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.ColorP3uiv() is true, calls ColorP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexP4ui() is true, calls VertexP4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendEquationi() is true, calls BlendEquationi() and yields the err returned by Util.Error(), if any.
...
//	If Support.UseProgramStages() is true, calls UseProgramStages() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribFormat() is true, calls VertexAttribFormat() and yields the err returned by Util.Error(), if any.
...
//	If Support.PixelStoref() is true, calls PixelStoref() and yields the err returned by Util.Error(), if any.
...
//	If Support.ColorP4uiv() is true, calls ColorP4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PointParameteri() is true, calls PointParameteri() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexP3uiv() is true, calls VertexP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteProgramPipelines() is true, calls DeleteProgramPipelines() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearStencil() is true, calls ClearStencil() and yields the err returned by Util.Error(), if any.
...
//	If Support.DepthFunc() is true, calls DepthFunc() and yields the err returned by Util.Error(), if any.
...
//	If Support.DetachShader() is true, calls DetachShader() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveUniform() is true, calls GetActiveUniform() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexImage3DMultisample() is true, calls TexImage3DMultisample() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexBuffer() is true, calls TexBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2iv() is true, calls ProgramUniform2iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexParameteriv() is true, calls GetTexParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PolygonOffset() is true, calls PolygonOffset() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2f() is true, calls ProgramUniform2f() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClientWaitSync() is true, calls ClientWaitSync() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearColor() is true, calls ClearColor() and yields the err returned by Util.Error(), if any.
...
//	If Support.ValidateProgramPipeline() is true, calls ValidateProgramPipeline() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4usv() is true, calls VertexAttribI4usv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1i() is true, calls ProgramUniform1i() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawArraysIndirect() is true, calls DrawArraysIndirect() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI3uiv() is true, calls VertexAttribI3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearDepth() is true, calls ClearDepth() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetQueryiv() is true, calls GetQueryiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiDrawElementsBaseVertex() is true, calls MultiDrawElementsBaseVertex() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI1iv() is true, calls VertexAttribI1iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawTransformFeedbackStreamInstanced() is true, calls DrawTransformFeedbackStreamInstanced() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI1uiv() is true, calls VertexAttribI1uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4uiv() is true, calls VertexAttribI4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindBufferRange() is true, calls BindBufferRange() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexParameteriv() is true, calls TexParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexP4uiv() is true, calls VertexP4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4i() is true, calls VertexAttribI4i() and yields the err returned by Util.Error(), if any.
...
//	If Support.PointParameterfv() is true, calls PointParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteTextures() is true, calls DeleteTextures() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyTexImage2D() is true, calls CopyTexImage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.CreateShaderProgramv() is true, calls CreateShaderProgramv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramResourceiv() is true, calls GetProgramResourceiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ScissorIndexed() is true, calls ScissorIndexed() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawArrays() is true, calls DrawArrays() and yields the err returned by Util.Error(), if any.
...
//	If Support.ActiveTexture() is true, calls ActiveTexture() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompressedTexSubImage2D() is true, calls CompressedTexSubImage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetBooleani_v() is true, calls GetBooleani_v() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribIPointer() is true, calls VertexAttribIPointer() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyTexImage1D() is true, calls CopyTexImage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP3uiv() is true, calls MultiTexCoordP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.EndQueryIndexed() is true, calls EndQueryIndexed() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsSync() is true, calls IsSync() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI2uiv() is true, calls VertexAttribI2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix4x2dv() is true, calls ProgramUniformMatrix4x2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenFramebuffers() is true, calls GenFramebuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawTransformFeedbackInstanced() is true, calls DrawTransformFeedbackInstanced() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetQueryIndexediv() is true, calls GetQueryIndexediv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsEnabled() is true, calls IsEnabled() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiDrawElementsIndirect() is true, calls MultiDrawElementsIndirect() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramInfoLog() is true, calls GetProgramInfoLog() and yields the err returned by Util.Error(), if any.
...
//	If Support.EndConditionalRender() is true, calls EndConditionalRender() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1iv() is true, calls ProgramUniform1iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElementsBaseVertex() is true, calls DrawElementsBaseVertex() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexLevelParameterfv() is true, calls GetTexLevelParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveAttrib() is true, calls GetActiveAttrib() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindProgramPipeline() is true, calls BindProgramPipeline() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI2i() is true, calls VertexAttribI2i() and yields the err returned by Util.Error(), if any.
...
//	If Support.ColorP4ui() is true, calls ColorP4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetBufferParameteri64v() is true, calls GetBufferParameteri64v() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetBufferParameteriv() is true, calls GetBufferParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenProgramPipelines() is true, calls GenProgramPipelines() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetQueryObjectuiv() is true, calls GetQueryObjectuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramParameteri() is true, calls ProgramParameteri() and yields the err returned by Util.Error(), if any.
...
//	If Support.ColorMaski() is true, calls ColorMaski() and yields the err returned by Util.Error(), if any.
...
//	If Support.ShaderSource() is true, calls ShaderSource() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSamplerParameterIiv() is true, calls GetSamplerParameterIiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSubroutineUniformLocation() is true, calls GetSubroutineUniformLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribLdv() is true, calls GetVertexAttribLdv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenerateMipmap() is true, calls GenerateMipmap() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetShaderPrecisionFormat() is true, calls GetShaderPrecisionFormat() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferTexture3D() is true, calls FramebufferTexture3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.InvalidateBufferData() is true, calls InvalidateBufferData() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawArraysInstanced() is true, calls DrawArraysInstanced() and yields the err returned by Util.Error(), if any.
...
//	If Support.ColorP3ui() is true, calls ColorP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendColor() is true, calls BlendColor() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribLFormat() is true, calls VertexAttribLFormat() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3dv() is true, calls ProgramUniform3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PointParameterf() is true, calls PointParameterf() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix4dv() is true, calls ProgramUniformMatrix4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.StencilOp() is true, calls StencilOp() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetBufferPointerv() is true, calls GetBufferPointerv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteTransformFeedbacks() is true, calls DeleteTransformFeedbacks() and yields the err returned by Util.Error(), if any.
...
//	If Support.PixelStorei() is true, calls PixelStorei() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix2x4fv() is true, calls ProgramUniformMatrix2x4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexParameterfv() is true, calls TexParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix3x2dv() is true, calls UniformMatrix3x2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribIiv() is true, calls GetVertexAttribIiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1d() is true, calls Uniform1d() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetIntegerv() is true, calls GetIntegerv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ResumeTransformFeedback() is true, calls ResumeTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.DebugMessageControl() is true, calls DebugMessageControl() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompressedTexImage1D() is true, calls CompressedTexImage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3iv() is true, calls ProgramUniform3iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsTransformFeedback() is true, calls IsTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4i() is true, calls Uniform4i() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexImage() is true, calls GetTexImage() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1dv() is true, calls ProgramUniform1dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ViewportIndexedfv() is true, calls ViewportIndexedfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.LineWidth() is true, calls LineWidth() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendFuncSeparate() is true, calls BlendFuncSeparate() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4d() is true, calls Uniform4d() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendFuncSeparatei() is true, calls BlendFuncSeparatei() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix2fv() is true, calls ProgramUniformMatrix2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetBooleanv() is true, calls GetBooleanv() and yields the err returned by Util.Error(), if any.
...
//	If Support.SecondaryColorP3ui() is true, calls SecondaryColorP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSamplerParameterfv() is true, calls GetSamplerParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1ui() is true, calls ProgramUniform1ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramPipelineiv() is true, calls GetProgramPipelineiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4iv() is true, calls ProgramUniform4iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ObjectPtrLabel() is true, calls ObjectPtrLabel() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexSubImage2D() is true, calls TexSubImage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3i() is true, calls ProgramUniform3i() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4f() is true, calls Uniform4f() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL4d() is true, calls VertexAttribL4d() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearBufferfv() is true, calls ClearBufferfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexLevelParameteriv() is true, calls GetTexLevelParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix4x2dv() is true, calls UniformMatrix4x2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteBuffers() is true, calls DeleteBuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompressedTexImage3D() is true, calls CompressedTexImage3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.LinkProgram() is true, calls LinkProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.InvalidateTexSubImage() is true, calls InvalidateTexSubImage() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetDebugMessageLog() is true, calls GetDebugMessageLog() and yields the err returned by Util.Error(), if any.
...
//	If Support.SamplerParameteriv() is true, calls SamplerParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawBuffer() is true, calls DrawBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix4x3fv() is true, calls ProgramUniformMatrix4x3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP1uiv() is true, calls TexCoordP1uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSamplerParameterIuiv() is true, calls GetSamplerParameterIuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribDivisor() is true, calls VertexAttribDivisor() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexImage3D() is true, calls TexImage3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetInteger64v() is true, calls GetInteger64v() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4ui() is true, calls ProgramUniform4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.Hint() is true, calls Hint() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3d() is true, calls ProgramUniform3d() and yields the err returned by Util.Error(), if any.
...
//	If Support.StencilFunc() is true, calls StencilFunc() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP2uiv() is true, calls VertexAttribP2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformSubroutinesuiv() is true, calls UniformSubroutinesuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.StencilMaskSeparate() is true, calls StencilMaskSeparate() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyImageSubData() is true, calls CopyImageSubData() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexP3ui() is true, calls VertexP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP1uiv() is true, calls MultiTexCoordP1uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.FlushMappedBufferRange() is true, calls FlushMappedBufferRange() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL1dv() is true, calls VertexAttribL1dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetAttribLocation() is true, calls GetAttribLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP2ui() is true, calls VertexAttribP2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI1ui() is true, calls VertexAttribI1ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4fv() is true, calls Uniform4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetInteger64i_v() is true, calls GetInteger64i_v() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4ui() is true, calls Uniform4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawTransformFeedback() is true, calls DrawTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveUniformBlockName() is true, calls GetActiveUniformBlockName() and yields the err returned by Util.Error(), if any.
...
//	If Support.MapBufferRange() is true, calls MapBufferRange() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetAttachedShaders() is true, calls GetAttachedShaders() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendEquationSeparatei() is true, calls BlendEquationSeparatei() and yields the err returned by Util.Error(), if any.
...
//	If Support.PatchParameterfv() is true, calls PatchParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ActiveShaderProgram() is true, calls ActiveShaderProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexParameteri() is true, calls TexParameteri() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenSamplers() is true, calls GenSamplers() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsTexture() is true, calls IsTexture() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformSubroutineuiv() is true, calls GetUniformSubroutineuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2i() is true, calls ProgramUniform2i() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformBlockIndex() is true, calls GetUniformBlockIndex() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP1ui() is true, calls TexCoordP1ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix3x4dv() is true, calls UniformMatrix3x4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.FrontFace() is true, calls FrontFace() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetQueryObjectui64v() is true, calls GetQueryObjectui64v() and yields the err returned by Util.Error(), if any.
...
//	If Support.Scissor() is true, calls Scissor() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL3d() is true, calls VertexAttribL3d() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP2uiv() is true, calls MultiTexCoordP2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.SecondaryColorP3uiv() is true, calls SecondaryColorP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendFunc() is true, calls BlendFunc() and yields the err returned by Util.Error(), if any.
...
//	If Support.UseProgram() is true, calls UseProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindTransformFeedback() is true, calls BindTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix3x2fv() is true, calls ProgramUniformMatrix3x2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP4ui() is true, calls TexCoordP4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetFragDataLocation() is true, calls GetFragDataLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.EndQuery() is true, calls EndQuery() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexSubImage3D() is true, calls TexSubImage3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindTexture() is true, calls BindTexture() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix3fv() is true, calls ProgramUniformMatrix3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribiv() is true, calls GetVertexAttribiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Clear() is true, calls Clear() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4uiv() is true, calls Uniform4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramResourceLocation() is true, calls GetProgramResourceLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3ui() is true, calls ProgramUniform3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1dv() is true, calls Uniform1dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ReadBuffer() is true, calls ReadBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.MinSampleShading() is true, calls MinSampleShading() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1uiv() is true, calls Uniform1uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferTexture() is true, calls FramebufferTexture() and yields the err returned by Util.Error(), if any.
...
//	If Support.ScissorIndexedv() is true, calls ScissorIndexedv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Viewport() is true, calls Viewport() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix2fv() is true, calls UniformMatrix2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.RenderbufferStorage() is true, calls RenderbufferStorage() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4iv() is true, calls VertexAttribI4iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompileShader() is true, calls CompileShader() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetShaderInfoLog() is true, calls GetShaderInfoLog() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferRenderbuffer() is true, calls FramebufferRenderbuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompressedTexSubImage1D() is true, calls CompressedTexSubImage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindImageTexture() is true, calls BindImageTexture() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveUniformBlockiv() is true, calls GetActiveUniformBlockiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.MapBuffer() is true, calls MapBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.StencilFuncSeparate() is true, calls StencilFuncSeparate() and yields the err returned by Util.Error(), if any.
...
//	If Support.DepthRange() is true, calls DepthRange() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteQueries() is true, calls DeleteQueries() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP1uiv() is true, calls VertexAttribP1uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramBinary() is true, calls GetProgramBinary() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL1d() is true, calls VertexAttribL1d() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribL2d() is true, calls VertexAttribL2d() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSynciv() is true, calls GetSynciv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2fv() is true, calls ProgramUniform2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PatchParameteri() is true, calls PatchParameteri() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteProgram() is true, calls DeleteProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexStorage2DMultisample() is true, calls TexStorage2DMultisample() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenQueries() is true, calls GenQueries() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexBindingDivisor() is true, calls VertexBindingDivisor() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexSubImage1D() is true, calls TexSubImage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.Enable() is true, calls Enable() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendFunci() is true, calls BlendFunci() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawBuffers() is true, calls DrawBuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribfv() is true, calls GetVertexAttribfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BeginQueryIndexed() is true, calls BeginQueryIndexed() and yields the err returned by Util.Error(), if any.
...
//	If Support.DepthRangef() is true, calls DepthRangef() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix3fv() is true, calls UniformMatrix3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexImage2DMultisample() is true, calls TexImage2DMultisample() and yields the err returned by Util.Error(), if any.
...
//	If Support.Enablei() is true, calls Enablei() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElementsIndirect() is true, calls DrawElementsIndirect() and yields the err returned by Util.Error(), if any.
...
//	If Support.CreateShader() is true, calls CreateShader() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribPointer() is true, calls VertexAttribPointer() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP1ui() is true, calls MultiTexCoordP1ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindBuffer() is true, calls BindBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyTexSubImage3D() is true, calls CopyTexSubImage3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexParameterIuiv() is true, calls GetTexParameterIuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PointSize() is true, calls PointSize() and yields the err returned by Util.Error(), if any.
...
//	If Support.PointParameteriv() is true, calls PointParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferParameteri() is true, calls FramebufferParameteri() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix2x4dv() is true, calls UniformMatrix2x4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform2d() is true, calls ProgramUniform2d() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlitFramebuffer() is true, calls BlitFramebuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetIntegeri_v() is true, calls GetIntegeri_v() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4i() is true, calls ProgramUniform4i() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI3i() is true, calls VertexAttribI3i() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferTexture1D() is true, calls FramebufferTexture1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyTexSubImage2D() is true, calls CopyTexSubImage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ViewportIndexedf() is true, calls ViewportIndexedf() and yields the err returned by Util.Error(), if any.
...
//	If Support.ReadPixels() is true, calls ReadPixels() and yields the err returned by Util.Error(), if any.
...
//	If Support.BeginConditionalRender() is true, calls BeginConditionalRender() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4d() is true, calls ProgramUniform4d() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP4uiv() is true, calls TexCoordP4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramBinary() is true, calls ProgramBinary() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1f() is true, calls ProgramUniform1f() and yields the err returned by Util.Error(), if any.
...
//	If Support.StencilOpSeparate() is true, calls StencilOpSeparate() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetRenderbufferParameteriv() is true, calls GetRenderbufferParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.InvalidateSubFramebuffer() is true, calls InvalidateSubFramebuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexBufferRange() is true, calls TexBufferRange() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyTexSubImage1D() is true, calls CopyTexSubImage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindAttribLocation() is true, calls BindAttribLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3iv() is true, calls Uniform3iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.FenceSync() is true, calls FenceSync() and yields the err returned by Util.Error(), if any.
...
//	If Support.SamplerParameteri() is true, calls SamplerParameteri() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetObjectLabel() is true, calls GetObjectLabel() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsRenderbuffer() is true, calls IsRenderbuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.BufferData() is true, calls BufferData() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformuiv() is true, calls GetUniformuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsSampler() is true, calls IsSampler() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform4iv() is true, calls Uniform4iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix3x2fv() is true, calls UniformMatrix3x2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveSubroutineUniformName() is true, calls GetActiveSubroutineUniformName() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix2x4fv() is true, calls UniformMatrix2x4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.CompressedTexImage2D() is true, calls CompressedTexImage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix2x3fv() is true, calls ProgramUniformMatrix2x3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix3x4fv() is true, calls ProgramUniformMatrix3x4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsProgramPipeline() is true, calls IsProgramPipeline() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix4fv() is true, calls ProgramUniformMatrix4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveSubroutineUniformiv() is true, calls GetActiveSubroutineUniformiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DepthMask() is true, calls DepthMask() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearBufferSubData() is true, calls ClearBufferSubData() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindVertexBuffer() is true, calls BindVertexBuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP2ui() is true, calls TexCoordP2ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.AttachShader() is true, calls AttachShader() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP1ui() is true, calls VertexAttribP1ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.ShaderBinary() is true, calls ShaderBinary() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetDoublei_v() is true, calls GetDoublei_v() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP2uiv() is true, calls TexCoordP2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3f() is true, calls Uniform3f() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetSubroutineIndex() is true, calls GetSubroutineIndex() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI2iv() is true, calls VertexAttribI2iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.SampleMaski() is true, calls SampleMaski() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1fv() is true, calls ProgramUniform1fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetFloati_v() is true, calls GetFloati_v() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP4uiv() is true, calls VertexAttribP4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DebugMessageInsert() is true, calls DebugMessageInsert() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetMultisamplefv() is true, calls GetMultisamplefv() and yields the err returned by Util.Error(), if any.
...
//	If Support.NormalP3uiv() is true, calls NormalP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix4fv() is true, calls UniformMatrix4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.LogicOp() is true, calls LogicOp() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetBufferSubData() is true, calls GetBufferSubData() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix2x3fv() is true, calls UniformMatrix2x3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DepthRangeArrayv() is true, calls DepthRangeArrayv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawTransformFeedbackStream() is true, calls DrawTransformFeedbackStream() and yields the err returned by Util.Error(), if any.
...
//	If Support.PopDebugGroup() is true, calls PopDebugGroup() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix4x3fv() is true, calls UniformMatrix4x3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BeginTransformFeedback() is true, calls BeginTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribdv() is true, calls GetVertexAttribdv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTransformFeedbackVarying() is true, calls GetTransformFeedbackVarying() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexImage2D() is true, calls TexImage2D() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetFramebufferParameteriv() is true, calls GetFramebufferParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.MemoryBarrier() is true, calls MemoryBarrier() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix3x4fv() is true, calls UniformMatrix3x4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramResourceLocationIndex() is true, calls GetProgramResourceLocationIndex() and yields the err returned by Util.Error(), if any.
...
//	If Support.WaitSync() is true, calls WaitSync() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetQueryObjecti64v() is true, calls GetQueryObjecti64v() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribPointerv() is true, calls GetVertexAttribPointerv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetTexParameterIiv() is true, calls GetTexParameterIiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearBufferfi() is true, calls ClearBufferfi() and yields the err returned by Util.Error(), if any.
...
//	If Support.PushDebugGroup() is true, calls PushDebugGroup() and yields the err returned by Util.Error(), if any.
...
//	If Support.SamplerParameterf() is true, calls SamplerParameterf() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindFragDataLocationIndexed() is true, calls BindFragDataLocationIndexed() and yields the err returned by Util.Error(), if any.
...
//	If Support.DisableVertexAttribArray() is true, calls DisableVertexAttribArray() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1iv() is true, calls Uniform1iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.SamplerParameterfv() is true, calls SamplerParameterfv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ScissorArrayv() is true, calls ScissorArrayv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteShader() is true, calls DeleteShader() and yields the err returned by Util.Error(), if any.
...
//	If Support.Flush() is true, calls Flush() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix2x4dv() is true, calls ProgramUniformMatrix2x4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2fv() is true, calls Uniform2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetCompressedTexImage() is true, calls GetCompressedTexImage() and yields the err returned by Util.Error(), if any.
...
//	If Support.CullFace() is true, calls CullFace() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexImage1D() is true, calls TexImage1D() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2uiv() is true, calls Uniform2uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI3iv() is true, calls VertexAttribI3iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PrimitiveRestartIndex() is true, calls PrimitiveRestartIndex() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveUniformName() is true, calls GetActiveUniformName() and yields the err returned by Util.Error(), if any.
...
//	If Support.InvalidateTexImage() is true, calls InvalidateTexImage() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformBlockBinding() is true, calls UniformBlockBinding() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiTexCoordP3ui() is true, calls MultiTexCoordP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.EndTransformFeedback() is true, calls EndTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix4x3dv() is true, calls UniformMatrix4x3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix2x3dv() is true, calls ProgramUniformMatrix2x3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1d() is true, calls ProgramUniform1d() and yields the err returned by Util.Error(), if any.
...
//	If Support.FramebufferTextureLayer() is true, calls FramebufferTextureLayer() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1ui() is true, calls Uniform1ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.TransformFeedbackVaryings() is true, calls TransformFeedbackVaryings() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix3dv() is true, calls UniformMatrix3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElementsInstanced() is true, calls DrawElementsInstanced() and yields the err returned by Util.Error(), if any.
...
//	If Support.ViewportArrayv() is true, calls ViewportArrayv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix3x4dv() is true, calls ProgramUniformMatrix3x4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramStageiv() is true, calls GetProgramStageiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP3uiv() is true, calls VertexAttribP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramiv() is true, calls GetProgramiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix4x2fv() is true, calls UniformMatrix4x2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveSubroutineName() is true, calls GetActiveSubroutineName() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP4ui() is true, calls VertexAttribP4ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.CreateProgram() is true, calls CreateProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetActiveUniformsiv() is true, calls GetActiveUniformsiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix2dv() is true, calls UniformMatrix2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3dv() is true, calls Uniform3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindRenderbuffer() is true, calls BindRenderbuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformLocation() is true, calls GetUniformLocation() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteRenderbuffers() is true, calls DeleteRenderbuffers() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4sv() is true, calls VertexAttribI4sv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4fv() is true, calls ProgramUniform4fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexStorage3D() is true, calls TexStorage3D() and yields the err returned by Util.Error(), if any.
...
//	If Support.ValidateProgram() is true, calls ValidateProgram() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawRangeElements() is true, calls DrawRangeElements() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsEnabledi() is true, calls IsEnabledi() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix3x2dv() is true, calls ProgramUniformMatrix3x2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2dv() is true, calls Uniform2dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3d() is true, calls Uniform3d() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindBufferBase() is true, calls BindBufferBase() and yields the err returned by Util.Error(), if any.
...
//	If Support.StencilMask() is true, calls StencilMask() and yields the err returned by Util.Error(), if any.
...
//	If Support.SampleCoverage() is true, calls SampleCoverage() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetDoublev() is true, calls GetDoublev() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearBufferiv() is true, calls ClearBufferiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.PolygonMode() is true, calls PolygonMode() and yields the err returned by Util.Error(), if any.
...
//	If Support.DeleteSync() is true, calls DeleteSync() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2d() is true, calls Uniform2d() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsShader() is true, calls IsShader() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexParameterIiv() is true, calls TexParameterIiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetError() is true, calls GetError() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetInternalformati64v() is true, calls GetInternalformati64v() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4f() is true, calls ProgramUniform4f() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawElementsInstancedBaseVertex() is true, calls DrawElementsInstancedBaseVertex() and yields the err returned by Util.Error(), if any.
...
//	If Support.CopyBufferSubData() is true, calls CopyBufferSubData() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3i() is true, calls Uniform3i() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix2x3dv() is true, calls UniformMatrix2x3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4ubv() is true, calls VertexAttribI4ubv() and yields the err returned by Util.Error(), if any.
...
//	If Support.UniformMatrix4dv() is true, calls UniformMatrix4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.MultiDrawElements() is true, calls MultiDrawElements() and yields the err returned by Util.Error(), if any.
...
//	If Support.Disable() is true, calls Disable() and yields the err returned by Util.Error(), if any.
...
//	If Support.BlendEquation() is true, calls BlendEquation() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexParameterIuiv() is true, calls TexParameterIuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.SamplerParameterIiv() is true, calls SamplerParameterIiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenTextures() is true, calls GenTextures() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform1uiv() is true, calls ProgramUniform1uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2f() is true, calls Uniform2f() and yields the err returned by Util.Error(), if any.
...
//	If Support.TextureView() is true, calls TextureView() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetShaderiv() is true, calls GetShaderiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetFramebufferAttachmentParameteriv() is true, calls GetFramebufferAttachmentParameteriv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix4x3dv() is true, calls ProgramUniformMatrix4x3dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4uiv() is true, calls ProgramUniform4uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3uiv() is true, calls Uniform3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribI4bv() is true, calls VertexAttribI4bv() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform3uiv() is true, calls ProgramUniform3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetProgramResourceName() is true, calls GetProgramResourceName() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindSampler() is true, calls BindSampler() and yields the err returned by Util.Error(), if any.
...
//	If Support.GenVertexArrays() is true, calls GenVertexArrays() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetString() is true, calls GetString() and yields the err returned by Util.Error(), if any.
...
//	If Support.ClearDepthf() is true, calls ClearDepthf() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformiv() is true, calls GetUniformiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform3fv() is true, calls Uniform3fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.CheckFramebufferStatus() is true, calls CheckFramebufferStatus() and yields the err returned by Util.Error(), if any.
...
//	If Support.DispatchCompute() is true, calls DispatchCompute() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform2iv() is true, calls Uniform2iv() and yields the err returned by Util.Error(), if any.
...
//	If Support.Uniform1f() is true, calls Uniform1f() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniformMatrix4x2fv() is true, calls ProgramUniformMatrix4x2fv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexStorage3DMultisample() is true, calls TexStorage3DMultisample() and yields the err returned by Util.Error(), if any.
...
//	If Support.ProgramUniform4dv() is true, calls ProgramUniform4dv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetVertexAttribIuiv() is true, calls GetVertexAttribIuiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.GetUniformdv() is true, calls GetUniformdv() and yields the err returned by Util.Error(), if any.
...
//	If Support.TexCoordP3uiv() is true, calls TexCoordP3uiv() and yields the err returned by Util.Error(), if any.
...
//	If Support.IsFramebuffer() is true, calls IsFramebuffer() and yields the err returned by Util.Error(), if any.
...
//	If Support.ReleaseShaderCompiler() is true, calls ReleaseShaderCompiler() and yields the err returned by Util.Error(), if any.
...
//	If Support.PauseTransformFeedback() is true, calls PauseTransformFeedback() and yields the err returned by Util.Error(), if any.
...
//	If Support.DrawRangeElementsBaseVertex() is true, calls DrawRangeElementsBaseVertex() and yields the err returned by Util.Error(), if any.
...
//	If Support.VertexAttribP3ui() is true, calls VertexAttribP3ui() and yields the err returned by Util.Error(), if any.
...
//	If Support.BindFramebuffer() is true, calls BindFramebuffer() and yields the err returned by Util.Error(), if any.
